...
namespace Utils.Reflection
{
	public abstract class DllMapper : IDisposable
	{
			...
			where T : DllMapper, new()
		{
			...
			foreach (var member in t.GetMembers(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.GetProperty | BindingFlags.Instance))
			{
