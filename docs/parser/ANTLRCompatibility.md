...
| `locals [...]` | `Rule.Locals` as raw text and `UP1008 RuleLocalsIgnored` | Recognized and preserved for passive descriptors; not executed, typed, or allocated into invocation-frame local stores. |
