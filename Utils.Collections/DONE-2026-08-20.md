...
The threshold contract now explicitly preserves the historical adaptive behavior: after the traversal counter exceeds the configured value, a subsequent unindexed node becomes eligible for promotion. Constructor diagnostics use threshold terminology, and deterministic tests pin exact insertion and lookup topology for thresholds 2, 3, and 10.
