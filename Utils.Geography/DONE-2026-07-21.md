...
## Findings from the follow-up audit (2026-07-10) — ALL FIXED 2026-07-21

All items below were fixed on branch `fix/utils-geography-todo` (PR #493).
Each item has its own commit with regression tests.
