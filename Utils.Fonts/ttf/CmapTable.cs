...
namespace Utils.Fonts.TTF
{
	public class CmapTable : TrueTypeTable
	{
		...
		private Dictionary<CmapSubtable, CMap> subtables;

		public virtual CMap[] CMaps
		{
			get
			{
		...
		public virtual CMap GetCMap(short platformID, short platformSpecificID) 
			=> (CMap)subtables[new CmapSubtable(platformID, platformSpecificID)];

		public virtual void AddCMap(short platformID, short platformSpecificID, CMap cm) 
		...
		{
			Version = 0;
			subtables = new Dictionary<CmapSubtable, CMap>();
		}
