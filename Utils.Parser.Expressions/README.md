...
See the [versioned API documentation for `omy.Utils.Parser.Expressions` 0.1.0](https://warny.github.io/All-purpose-Utilities/v2.0.0-rc.2/api/Utils.Parser.Expressions.html).
