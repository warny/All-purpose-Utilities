...
internal static partial class GrammarEmitter
{
        ...
        bool enableGeneratedRuleArgumentBinding = false)
    {
        ...
        var lexerMembers = CollectLexerMembers(grammar);
        var parserFooters = CollectParserFooters(grammar);
        var lexerFooters = CollectLexerFooters(grammar);
        ...
        EmitLexerHeaders(sb, lexerHeaders, grammar, embeddedCodeTransformer);
