...
Completed on 2026-08-21. Composite conversions now assemble unfinalized numeric and ordinal fragments, then apply adjustment, end triggers, and language finalization once at the public phrase boundary. A non-idempotent recording finalizer covers the affected public surface matrix.
