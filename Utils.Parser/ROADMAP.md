...
- Lexer actions, lexer predicates, unsupported grammar actions, `@lexer::header`, `@lexer::members`, and automatic default execution remain not done and must not be documented as complete.
