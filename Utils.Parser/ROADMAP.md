...
The generated-C# rule-call argument binding option now benefits from bounded static diagnostics for locally declared parser-rule targets. This does not complete Phase 7 and does not expand supported syntax. Future work remains for imported signatures, named arguments, expressions, user-defined types, and C# semantic analysis.
