...
public class ReparteedRandom
{
	...
	public ReparteedRandom(Func<double, double> repartitionFunction, Random r)
	{
		this.r = r;
	...
	public ReparteedRandom(Func<double, double> repartitionFunction)
	{
		this.r = new Random();
		this.repartitionFunction = repartitionFunction;
		min = repartitionFunction(0);
	...
	public ReparteedRandom(Func<double, double> repartitionFunction, int seed)
	{
