...
$gates = @(
    ...
    [pscustomobject]@{ Name = "release-warnings"; Display = "Release warnings"; Skip = $false; Action = { & "$PSScriptRoot/validate-release-warnings.ps1" -Configuration $Configuration -ArtifactsPath $ArtifactsPath } },
