...
if ($pr.perConsumerVulnerabilityAudit -or $pr.exhaustiveGeneratorMatrices -or $pr.remoteSourceLink -or $pr.reproducibility -or $pr.deprecatedAudit -or $pr.outdatedAudit) {
...
if ($full.consumers.Count -ne $allProjects.Count -or -not $full.perConsumerVulnerabilityAudit -or -not $full.exhaustiveGeneratorMatrices -or -not $full.remoteSourceLink -or -not $full.reproducibility -or -not $full.deprecatedAudit -or -not $full.outdatedAudit) {
