...
public sealed class EmbeddedCodeTransformationInvariantTests
{
    ...
    public void Emit_WhenMultipleNamedActionsShareCategory_PreservesTransformationAndSourceOrder()
    {
        ...
        // Normalize CRLF → LF so assertions are portable across platforms (AppendLine uses Environment.NewLine).
        string lf = source.Replace("\r\n", "\n");
        StringAssert.Contains(lf, "// <auto-generated-parser-header>\n// TRANSFORMED_PARSER_HEADER_01");
        StringAssert.Contains(lf, "// <auto-generated-parser-header>\n// TRANSFORMED_PARSER_HEADER_02");
        StringAssert.Contains(lf, "    // <auto-generated-lexer-members>\n    private int transformedLexerMembers03;");
