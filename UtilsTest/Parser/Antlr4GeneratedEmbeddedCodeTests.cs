...
public class Antlr4GeneratedEmbeddedCodeTests
{
    ...
    /// <summary>Ensures current-rule return writes are readable in the same embedded action.</summary>
    [TestMethod]
    public void ParseWithEmbeddedCode_AssignsCurrentRuleReturn()
    {
        const string grammar = """
            grammar P;
            @members {
        ...
        StringAssert.Contains(source, "Seen = GetRequiredRuleReturn<int>(context, \"value\")");
        var assembly = CompileGeneratedSource(source);
        var executionContext = CreateExecutionContext(assembly);
    ...
    /// <summary>Ensures unlabeled child return access remains unsupported.</summary>
    [TestMethod]
    ...
    /// <summary>Ensures present-null current-rule return values remain distinguishable from missing returns.</summary>
    [TestMethod]
    public void ParseWithEmbeddedCode_NullReturnWrite_IsPresentForCurrentRead()
    {
        const string grammar = """
            grammar P;
            @members {
    ...
    /// <summary>
    /// Ensures unscoped and parser-scoped member actions use the same generated execution-context injection path.
    /// </summary>
    [TestMethod]
    public void ParserMembers_AndParserScopedMembers_UseSameGeneratedExecutionContextInjectionPath()
    {
        const string unscopedGrammar = """
            grammar P;
        ...
        foreach (string grammar in new[] { unscopedGrammar, scopedGrammar })
        {
            string source = Emit(grammar);
            int contextStart = source.IndexOf("internal sealed partial class PExecutionContext", StringComparison.Ordinal);
            int membersStart = source.IndexOf("public int Seen = 1;", StringComparison.Ordinal);
    ...
    /// <summary>
    /// Ensures unscoped and parser-scoped headers use the same parser header injection and transformer path.
    /// </summary>
    [TestMethod]
    public void ParserHeader_AndParserScopedHeader_UseSameGeneratedHeaderInjectionPath()
    {
        const string grammar = """
            grammar P;
        ...
        StringAssert.Contains(source, "// <auto-generated-parser-header>");
        StringAssert.Contains(source, "using System;");
        StringAssert.Contains(source, "using System.Linq;");
    ...
    /// <summary>
    /// Ensures unscoped and parser-scoped footers use the same parser footer injection and transformer path.
    /// </summary>
    [TestMethod]
    public void ParserFooter_AndParserScopedFooter_UseSameGeneratedFooterInjectionPath()
    {
        const string grammar = """
            grammar P;

            @footer { internal sealed class FooterA { } }
            @parser::footer { internal sealed class FooterB { } }
        ...
        StringAssert.Contains(source, "// <auto-generated-parser-footer>");
        StringAssert.Contains(source, "internal sealed class FooterA { }");
        StringAssert.Contains(source, "internal sealed class FooterB { }");
        Assert.IsTrue(source.IndexOf("FooterA", StringComparison.Ordinal) < source.IndexOf("FooterB", StringComparison.Ordinal), source);
        _ = CompileGeneratedSource(source);
    }

    /// <summary>
    /// Ensures rule-return metadata does not create public ANTLR-style rule context signatures or change conservative parsing.
    /// </summary>
    [TestMethod]
    public void RuleReturns_MetadataDoesNotEnableAutomaticGeneratedAccess()
    {
        const string grammar = """
            grammar P;
        ...
        Assert.AreEqual("int value", parsed.ParserRules.Single(rule => rule.Name == "child").Returns);
        Assert.IsFalse(source.Contains("public ParseNode child", StringComparison.Ordinal), source);
        Assert.IsFalse(source.Contains("child()", StringComparison.Ordinal), source);
        Assert.IsNotInstanceOfType(InvokeParse(assembly, "Parse", "a"), typeof(ErrorNode));
    }

    /// <summary>
    /// Ensures labeled rule-call metadata does not promise ANTLR context or label property access.
    /// </summary>
    [TestMethod]
    public void LabeledRuleCall_MetadataDoesNotEnableAntlrStyleLabelAccess()
    {
        const string grammar = """
            grammar P;
        ...
        Assert.IsFalse(source.Contains("public ParseNode child", StringComparison.Ordinal), source);
        Assert.IsFalse(source.Contains(".ctx", StringComparison.Ordinal), source);
        Assert.IsFalse(source.Contains("$c.value", StringComparison.Ordinal), source);
        Assert.IsNotInstanceOfType(InvokeParse(assembly, "Parse", "a"), typeof(ErrorNode));
    }
    ...
    /// <summary>
    /// Ensures all parser and lexer named-action regions inject transformed text through generated markers once.
    /// </summary>
    [TestMethod]
    public void Emit_WhenTransformerReplacesNamedActions_UsesTransformedMarkedRegions()
    {
        const string grammar = """
            grammar P;
        ...
        string source = EmitWithTransformer(grammar, new LocationMarkerEmbeddedCodeTransformer());

        AssertMarkedRegion(source, "// <auto-generated-parser-header>", "// </auto-generated-parser-header>", "TRANSFORMED_PARSER_HEADER", indentation: "");
        AssertMarkedRegion(source, "    // <auto-generated-parser-members>", "    // </auto-generated-parser-members>", "    int TRANSFORMED_PARSER_MEMBERS = 0;", indentation: "    ");
        AssertMarkedRegion(source, "// <auto-generated-parser-footer>", "// </auto-generated-parser-footer>", "TRANSFORMED_PARSER_FOOTER", indentation: "");
        AssertMarkedRegion(source, "// <auto-generated-lexer-header>", "// </auto-generated-lexer-header>", "TRANSFORMED_LEXER_HEADER", indentation: "");
        AssertMarkedRegion(source, "    // <auto-generated-lexer-members>", "    // </auto-generated-lexer-members>", "    int TRANSFORMED_LEXER_MEMBERS = 0;", indentation: "    ");
        AssertMarkedRegion(source, "// <auto-generated-lexer-footer>", "// </auto-generated-lexer-footer>", "TRANSFORMED_LEXER_FOOTER", indentation: "");
        Assert.IsFalse(source.Contains("RAW_PARSER_HEADER", StringComparison.Ordinal), source);
        Assert.IsFalse(source.Contains("RAW_LEXER_FOOTER", StringComparison.Ordinal), source);
    }

    /// <summary>
    /// Ensures parser hook bodies, predicates, and lifecycle hooks inject transformed code.
    /// </summary>
    [TestMethod]
    public void Emit_WhenTransformerReplacesParserHooks_UsesTransformedHookBodies()
    {
        const string grammar = """
            grammar P;
            start
        ...
        StringAssert.Contains(source, "        return TRANSFORMED_PARSER_PREDICATE;");
        StringAssert.Contains(source, "        int TRANSFORMED_PARSER_ACTION = 0;");
        StringAssert.Contains(source, "        int TRANSFORMED_RULE_INIT = 0;");
        StringAssert.Contains(source, "        int TRANSFORMED_RULE_AFTER = 0;");
        Assert.IsFalse(source.Contains("return RAW_PREDICATE;", StringComparison.Ordinal), source);
        Assert.IsFalse(source.Contains("        RAW_ACTION;", StringComparison.Ordinal), source);
    }

    /// <summary>
    /// Ensures lexer action and predicate hook bodies inject transformed code.
    /// </summary>
    [TestMethod]
    public void Emit_WhenTransformerReplacesLexerHooks_UsesTransformedHookBodies()
    {
        const string grammar = """
            lexer grammar P;
            A : { RAW_LEXER_PREDICATE }? 'a' { RAW_LEXER_ACTION; } ;
        ...
        StringAssert.Contains(source, "        return TRANSFORMED_LEXER_PREDICATE;");
        StringAssert.Contains(source, "        int TRANSFORMED_LEXER_ACTION = 0;");
    ...
    public void EmbeddedCodeHookTypes_WhenCreatedThroughFactories_PreserveFourCategories()
    {
        ...
        Type hookType = emitterType.GetNestedType("EmbeddedCodeHook", BindingFlags.NonPublic)!;
        Type kindType = emitterType.GetNestedType("EmbeddedCodeHookKind", BindingFlags.NonPublic)!;
        object predicateKind = Enum.Parse(kindType, "SemanticPredicate");
        object actionKind = Enum.Parse(kindType, "InlineAction");

        object[] hooks =
        [
            InvokeHookFactory(hookType, "CreateParser", "start", "RAW_PARSER_PREDICATE", predicateKind, 0, 0, "__Predicate_start_0_0_0"),
            InvokeHookFactory(hookType, "CreateParser", "start", "RAW_PARSER_ACTION;", actionKind, 0, 1, "__Action_start_0_1_1"),
            InvokeHookFactory(hookType, "CreateLexer", "A", "RAW_LEXER_PREDICATE", predicateKind, 0, 0, "__LexerPredicate_A_0_0_0"),
    ...
    public void EmbeddedCodeHookTypes_WhenInvalidStateIsCreated_RejectsIt()
    {
        ...
        AssertFactoryThrows<ArgumentException>(() => InvokeHookFactory(hookType, "CreateParser", "", "RAW_ACTION;", actionKind, 0, 0, "__Action_start_0_0_0"));
        AssertFactoryThrows<ArgumentNullException>(() => InvokeHookFactory(hookType, "CreateParser", "start", null!, actionKind, 0, 0, "__Action_start_0_0_0"));
        AssertFactoryThrows<ArgumentOutOfRangeException>(() => InvokeHookFactory(hookType, "CreateParser", "start", "RAW_ACTION;", actionKind, -2, 0, "__Action_start_0_0_0"));
        AssertFactoryThrows<ArgumentOutOfRangeException>(() => InvokeHookFactory(hookType, "CreateParser", "start", "RAW_ACTION;", actionKind, 0, -2, "__Action_start_0_0_0"));
    ...
    public void Emit_WhenParserAndLexerHooksShareGrammar_PreservesStableCategoriesAndGeneratedBodies()
    {
        const string grammar = """
            grammar P;
            start : { RAW_PARSER_PREDICATE }? A { RAW_PARSER_ACTION; } ;
            A : { RAW_LEXER_PREDICATE }? 'a' { RAW_LEXER_ACTION; } ;
            """;

        string source = EmitWithTransformer(grammar, new LocationMarkerEmbeddedCodeTransformer());

        StringAssert.Contains(source, "private bool __Predicate_start_0_0_0(SemanticPredicateEvaluationContext context)");
        StringAssert.Contains(source, "private void __Action_start_0_2_1(ParserActionExecutionContext context)");
        StringAssert.Contains(source, "private void __LexerAction_A_0_2_1(LexerActionExecutionContext context, LexerActionExecutionResult result)");
        StringAssert.Contains(source, "private bool __LexerPredicate_A_0_0_0(LexerPredicateEvaluationContext context)");
        Assert.AreEqual(1, CountHookOccurrences(source, "return TRANSFORMED_PARSER_PREDICATE;"));
        Assert.AreEqual(1, CountHookOccurrences(source, "int TRANSFORMED_PARSER_ACTION = 0;"));
        Assert.AreEqual(1, CountHookOccurrences(source, "return TRANSFORMED_LEXER_PREDICATE;"));
        Assert.AreEqual(1, CountHookOccurrences(source, "int TRANSFORMED_LEXER_ACTION = 0;"));
        Assert.IsFalse(source.Contains("return RAW_PARSER_PREDICATE;", StringComparison.Ordinal));
        Assert.IsFalse(source.Contains("        RAW_PARSER_ACTION;", StringComparison.Ordinal));
        Assert.IsFalse(source.Contains("return RAW_LEXER_PREDICATE;", StringComparison.Ordinal));
        Assert.IsFalse(source.Contains("        RAW_LEXER_ACTION;", StringComparison.Ordinal));
    }
    ...
    private static void AssertFactoryThrows<TException>(Action action) where TException : Exception
    {
        ...
        {
            Assert.IsInstanceOfType(exception.InnerException, typeof(TException));
        }
    }
    ...
    /// </summary>
    private static void AssertMarkedRegion(string source, string startMarker, string endMarker, string transformedLine, string indentation)
    {
        StringAssert.Contains(source, startMarker);
        StringAssert.Contains(source, endMarker);
        Assert.AreEqual(1, CountOccurrences(source, transformedLine), source);
        StringAssert.Contains(source, transformedLine);
    ...
    /// <summary>
    /// Counts non-overlapping ordinal occurrences in generated source.
    /// </summary>
    ...
    /// <summary>
    /// Test transformer that emits deterministic markers for every supported generated C# injection location.
    /// </summary>
    private sealed class LocationMarkerEmbeddedCodeTransformer : IParserEmbeddedCodeTransformer
    {
        /// <inheritdoc />
        public ParserEmbeddedCodeTransformationResult Transform(ParserEmbeddedCodeTransformationContext context)
        {
            string code = context.Location switch
            {
                ParserEmbeddedCodeLocation.ParserHeader => "// TRANSFORMED_PARSER_HEADER",
                ParserEmbeddedCodeLocation.ParserMembers => "int TRANSFORMED_PARSER_MEMBERS = 0;",
                ParserEmbeddedCodeLocation.ParserFooter => "// TRANSFORMED_PARSER_FOOTER",
                ParserEmbeddedCodeLocation.LexerHeader => "// TRANSFORMED_LEXER_HEADER",
                ParserEmbeddedCodeLocation.LexerMembers => "int TRANSFORMED_LEXER_MEMBERS = 0;",
                ParserEmbeddedCodeLocation.LexerFooter => "// TRANSFORMED_LEXER_FOOTER",
                ParserEmbeddedCodeLocation.SemanticPredicate => "TRANSFORMED_PARSER_PREDICATE",
                ParserEmbeddedCodeLocation.InlineAction => "int TRANSFORMED_PARSER_ACTION = 0;",
                ParserEmbeddedCodeLocation.RuleInit => "int TRANSFORMED_RULE_INIT = 0;",
                ParserEmbeddedCodeLocation.RuleAfter => "int TRANSFORMED_RULE_AFTER = 0;",
                ParserEmbeddedCodeLocation.LexerSemanticPredicate => "TRANSFORMED_LEXER_PREDICATE",
                ParserEmbeddedCodeLocation.LexerInlineAction => "int TRANSFORMED_LEXER_ACTION = 0;",
                _ => context.Code
            };
