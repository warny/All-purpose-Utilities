...
Examples:
    ...
    | 1            | x                                | -2,-1,0,1,2.5                             | 1e-9      |
    | x            | x**2/2                           | -2,-1,0,1,2.5                             | 1e-9      |
    | x**2         | x**3/3                           | -2,-1,0,1,2                               | 1e-9      |
    | 3/x          | 3*Log(x)                         | 0.5,1,2.718281828459045,5                 | 1e-9      |
    ...
    | Sin(2*x)     | -Cos(2*x)/2                      | -1.5707963267948966,0,0.7853981633974483,3.141592653589793 | 1e-9 |
    | Exp(x)       | Exp(x)                           | -2,-1,0,1,2                               | 1e-9      |
    | Log(x)       | x*(Log(x)-1)                     | 0.5,1,2.718281828459045,5                 | 1e-9      |
    | Log10(x)     | x*Log10(x)-x/Log(10)             | 1,2,10,100                                | 1e-9      |
    | 2*Sin(x)     | -2*Cos(x)                        | -3.141592653589793,0,1.5707963267948966,3.141592653589793 | 1e-9 |
    | x + Sin(x)   | x**2/2-Cos(x)                    | -2,-1,0,1,2                               | 1e-9      |
